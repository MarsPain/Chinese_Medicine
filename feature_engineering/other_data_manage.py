...
print("taste_dict_sorted:", len(taste_dict_sorted), taste_dict_sorted)
print("type_dict_sorted:", len(type_dict_sorted), type_dict_sorted)
print("function_dict_sorted:", len(function_dict_sorted), function_dict_sorted)

# 对人工标注的分词结果进行统计
# path = "data/dict_function/set3_true_dict_labeld.txt"
# with open(path, "r", encoding="utf-8") as f:
#     lines = f.readlines()
